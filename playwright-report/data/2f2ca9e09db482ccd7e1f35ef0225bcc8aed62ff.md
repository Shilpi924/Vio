...
- Name: free-play.spec.ts >> Free Play Page Tests >> virtual fingerboard is displayed
- Location: tests/free-play.spec.ts:81:3
...
Locator: locator('.fingerboard, [data-testid="fingerboard"], canvas, svg').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.fingerboard, [data-testid="fingerboard"], canvas, svg').first()
