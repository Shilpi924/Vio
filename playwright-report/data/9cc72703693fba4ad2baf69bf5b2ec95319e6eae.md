...
- Name: statistics.spec.ts >> Statistics Page Tests >> practice tips section is displayed
- Location: tests/statistics.spec.ts:74:3
...
Locator: getByText('💡 Practice Tips')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('💡 Practice Tips')
