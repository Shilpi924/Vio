...
- Name: beginner-path.spec.ts >> Beginner Path Page Tests >> lessons are clickable
- Location: tests/beginner-path.spec.ts:28:3
...
Locator: locator('.lesson, [data-testid="lesson"], .card, button').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.lesson, [data-testid="lesson"], .card, button').first()
