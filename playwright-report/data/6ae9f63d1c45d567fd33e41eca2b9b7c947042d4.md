...
- Name: statistics.spec.ts >> Statistics Page Tests >> recent activity section is displayed
- Location: tests/statistics.spec.ts:47:3
...
Locator: getByText('Recent Activity')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Recent Activity')
