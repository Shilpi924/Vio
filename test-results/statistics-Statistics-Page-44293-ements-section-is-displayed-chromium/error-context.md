...
- Name: statistics.spec.ts >> Statistics Page Tests >> achievements section is displayed
- Location: tests/statistics.spec.ts:67:3
...
Locator: getByText('Achievements')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Achievements')
