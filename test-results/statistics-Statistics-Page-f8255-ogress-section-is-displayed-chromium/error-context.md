...
- Name: statistics.spec.ts >> Statistics Page Tests >> skills progress section is displayed
- Location: tests/statistics.spec.ts:51:3
...
Locator: getByText('Skills Progress')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Skills Progress')
