...
- Name: home-page.spec.ts >> Home Page Tests >> more tools section expands and collapses
- Location: tests/home-page.spec.ts:62:3
...
Call log:
  ...
  - waiting for getByText('More Tools')
