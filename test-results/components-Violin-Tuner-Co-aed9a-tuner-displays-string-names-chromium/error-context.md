...
```
Error: locator.isVisible: Error: strict mode violation: getByText('G') resolved to 6 elements:
    1) <p class="mt-2 text-lg font-medium text-white/80">Follow the guided learning roadmap.</p> aka getByRole('button', { name: 'Path Follow the guided' })
    2) <h2 class="text-4xl font-black tracking-tight">Song Library</h2> aka getByRole('button', { name: 'Song Library Learn your' })
    3) <p class="mt-2 text-lg font-medium text-white/80">Learn your favorite songs step-by-step.</p> aka getByRole('button', { name: 'Song Library Learn your' })
    4) <p class="text-sm font-medium text-white/80">Play fun mini-games</p> aka getByRole('button', { name: 'Arcade Play fun mini-games' })
    5) <h3 class="text-xl font-black">My Progress</h3> aka getByRole('button', { name: 'My Progress See your' })
    6) <h3 class="text-xl font-black">Settings</h3> aka getByRole('button', { name: 'Settings Tweak your piano' })
