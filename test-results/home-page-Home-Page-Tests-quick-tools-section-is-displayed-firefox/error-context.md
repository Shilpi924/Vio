...
- Name: home-page.spec.ts >> Home Page Tests >> quick tools section is displayed
- Location: tests/home-page.spec.ts:44:3
...
Call log:
  ...
  - waiting for getByText('Quick Tools')
