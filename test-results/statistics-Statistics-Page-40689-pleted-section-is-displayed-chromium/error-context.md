...
- Name: statistics.spec.ts >> Statistics Page Tests >> lessons completed section is displayed
- Location: tests/statistics.spec.ts:40:3
...
Locator: getByText('Lessons Completed')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Lessons Completed')
