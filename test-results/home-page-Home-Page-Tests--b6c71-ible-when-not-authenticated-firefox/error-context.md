...
- Name: home-page.spec.ts >> Home Page Tests >> Google Sign In button is visible when not authenticated
- Location: tests/home-page.spec.ts:99:3
...
Locator: getByText('Sign in with Google')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('Sign in with Google')
